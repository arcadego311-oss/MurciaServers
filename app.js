  ...
  return `
    ...
    <header class="site-header">
      <div class="header-inner">
        <a class="logo" href="#/maps" aria-label="Murcia Servers home"><span class="logo-mark"><img src="assets/murcia-servers-logo-static.png" alt="" width="42" height="42"></span>Murcia Servers</a>
